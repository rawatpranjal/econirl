...
\begin{table}[H]
\centering
\caption{Estimator capabilities. All six classical and approximate estimators share the same parametric MLE objective and differ only in how they solve the Bellman constraint. The IRL estimators use fundamentally different identification strategies.}
\label{tab:estimators}
\footnotesize
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} l l c c c c c}
\toprule
Estimator & Reference & Dir. & $P$ req. & SEs & Scales & Transfer \\
\midrule
NFXP-NK    & \citealt{rust1987}            & Fwd & \checkmark & Analytical & & \\
CCP-NPL    & \citealt{hotzMiller1993}      & Fwd & \checkmark & Hessian    & & \\
MPEC       & \citealt{suJudd2012}          & Fwd & \checkmark & Hessian    & & \\
\midrule
NNES       & \citealt{nguyen2025}          & Fwd & \checkmark & Valid      & \checkmark & \\
TD-CCP     & \citealt{adusumilliEckardt2025} & Fwd &          & Robust     & \checkmark & \\
SEES       & \citealt{luoSang2024}         & Fwd & \checkmark & Marginal   & \checkmark & \\
\midrule
MCE-IRL    & \citealt{ziebart2010}         & Inv & \checkmark & Bootstrap  & & \\
AIRL       & \citealt{fu2018}              & Inv &            &            & & \checkmark \\
GLADIUS    & \citealt{kang2025}            & Inv & \checkmark & Projected  & \checkmark & \\
f-IRL      & \citealt{ni2022}              & Inv & \checkmark &            & & \\
IQ-Learn   & \citealt{garg2021}            & Inv & \checkmark &            & & \\
BC         & \citealt{pomerleau1991}       & Imit &           &            & & \\
\bottomrule
\end{tabular*}
\end{table}
...
Appendix~\ref{sec:iq_learn} shows that in the tabular DDC setting this objective is algebraically equivalent to a penalized conditional log-likelihood.
